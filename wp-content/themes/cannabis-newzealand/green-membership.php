<?php /* Template Name: Green Membership */ ?>
<?php get_header();?>
		...
		<div class="row">
			<div class="col-md-12">
				<div class="title-outer">
					<h1 data-aos="fade-right" data-aos-duration="3000" class="title text-white aos-init aos-animate">Green</h1>
					<ul class="page-breadcrumb aos-init" data-aos="fade- " data-aos-duration="3000">
						<li><a href="index.php">Home</a></li>
						<li>Green membership</li>
					</ul>
				</div>
			</div>
		</div>
...
<section class="memberSipDetails">
					...
					<div class="row">
						<div class="col-md-3">
							<div class="productBox">
								<img src="https://webbersunited.com/cms/cannabis-newzealand/wp-content/uploads/2023/01/thist.png" />
							</div>
						</div>
						<div class="col-md-3">
							<div class="productBox">
								<img src="https://webbersunited.com/cms/cannabis-newzealand/wp-content/uploads/2023/01/pro1.png" />
							</div>
						</div>
						<div class="col-md-3">
							<div class="productBox">
			...
			<div class="col-md-6">
				<div class="pricing-section">
					<div class="outer-box">
                        ...
                        <div class="inner-box greenBox">
                            <div class="icon-box">
                                <div class="icon-outer"><i class="fas fa-paper-plane"></i></div>
                            </div>
                            <div class="price-box">
                                <div class="title"> Green membership</div>
