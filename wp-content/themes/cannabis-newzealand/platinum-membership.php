<?php /* Template Name: Platinum Membership */ ?>
<?php get_header();?>
		...
		<div class="row">
			<div class="col-md-12">
				<div class="title-outer">
					<h1 data-aos="fade-right" data-aos-duration="3000" class="title text-white aos-init aos-animate">Platinum</h1>
			...
			<div class="col-md-6">
				<div class="pricing-section">
					<div class="outer-box">
                        ...
                        <div class="inner-box platinumBox">
                            <div class="icon-box">
                                <div class="icon-outer"><i class="fas fa-paper-plane"></i></div>
                            </div>
                            <div class="price-box">
                                <div class="title"> Platinum membership</div>
