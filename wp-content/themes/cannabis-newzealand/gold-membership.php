<?php /* Template Name: Gold Membership */ ?>
<?php get_header();?>
		...
		<div class="row">
			<div class="col-md-12">
				<div class="title-outer">
					<h1 data-aos="fade-right" data-aos-duration="3000" class="title text-white aos-init aos-animate">Gold</h1>
